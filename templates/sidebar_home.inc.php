...
<ul class="sb2" id="sb_home">
    <li class="<?php echo (string) $_COOKIE['sb_browse_music']; ?>">
    ...
    <?php if (AmpConfig::get('allow_video') && Video::get_item_count('Video')) {
            ?>
        <li class="sb2_video <?php  echo (string) $_COOKIE['sb_browse_video']; ?>">
    ...
    <li class="sb2_random <?php echo (string) $_COOKIE['sb_random']; ?>">
    ...
    <li class="sb2_search <?php echo (string) $_COOKIE['sb_search']; ?>">
    ...
    <li class="sb2_playlist <?php echo (string) $_COOKIE['sb_home_playlist']; ?>">
    ...
    <li class="sb2_information <?php echo (string) $_COOKIE['sb_info']; ?>">
